...
If you've found a security issue in Ronsel, please **do not file a public issue**. Public disclosure before a fix is shipped exposes other users to the same risk.

Instead, contact the maintainers privately:

- **Email**: <security@ronsel.app> (replace with the project's real address before publishing)
